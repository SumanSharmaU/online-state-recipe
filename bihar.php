...
<head>
    ...
    <title>Recipes of Bihar</title>
    <link rel="stylesheet" href="approved_recipe1.css"> <!-- Include the shared CSS -->
</head>
<body>
    <header>
        <h1>Recipes of Bihar</h1>
    </header>
    ...
    <div class="recipe-cards">
        <?php
            ...
            // Retrieve approved recipes for Bihar
            $sql = "SELECT * FROM recipes WHERE status = 'approved' AND state = 'Bihar'";
