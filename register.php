...
if (isset($_POST['submit'])) {
   ...
   // Add code to get the selected user type (user or admin) from the form
   ...
   if ($select->rowCount() > 0) {
      ...
      if ($pass != $cpass) {
         ...
         $insert->execute([$name, $email, $cpass, $image, $user_type]); // Include user_type in the INSERT query
         if ($insert) {
