...
<head>
    ...
    <title>Recipes of Kerala</title>
    <link rel="stylesheet" href="approved_recipe.css">
</head>
<body>
    <header>
        <h1>Recipes of Kerala</h1>
    </header>
    ...
    <div class="recipe-cards">
        ...
        // Retrieve approved recipes for Kerala
        $sql = "SELECT * FROM recipes WHERE status = 'approved' AND state = 'Kerala'";
        $result = mysqli_query($conn, $sql);

        // Display approved recipes for Kerala
