...
<head>
    ...
    <title>Recipes of Tamil Nadu</title>
    <link rel="stylesheet" href="approved_recipe.css">
</head>
<body>
    <header>
        <h1>Recipes of Tamil Nadu</h1>
    </header>
    ...
    <div class="recipe-cards">
        ...
        // Retrieve approved recipes for Tamil Nadu
        $sql = "SELECT * FROM recipes WHERE status = 'approved' AND state = 'Tamil Nadu'";
        $result = mysqli_query($conn, $sql);

        // Display approved recipes for Tamil Nadu
