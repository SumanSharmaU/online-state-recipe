...
<head>
    ...
    <title>Recipes of Maharashtra</title>
    <link rel="stylesheet" href="approved_recipe.css">
</head>
<body>
    <header>
        <h1>Recipes of Maharashtra</h1>
    </header>
    ...
    <div class="recipe-cards">
        ...
        // Retrieve approved recipes for Maharashtra
        $sql = "SELECT * FROM recipes WHERE status = 'approved' AND state = 'Maharashtra'";
        $result = mysqli_query($conn, $sql);

        // Check if there are approved recipes for Maharashtra
